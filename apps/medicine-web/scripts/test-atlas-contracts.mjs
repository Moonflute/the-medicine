...
assert.equal(organs.length,36);assert.equal(diseaseMappings.length,12);
console.log('Atlas contracts passed: 36 organs, icons and both quality assets; 12 exact disease/scenario links.');

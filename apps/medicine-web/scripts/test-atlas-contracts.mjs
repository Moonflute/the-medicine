...
assert.equal(organs.length,37);assert.equal(diseaseMappings.length,12);
console.log('Atlas contracts passed: 36 organs plus skeleton, icons and both quality assets; 12 exact disease/scenario links.');

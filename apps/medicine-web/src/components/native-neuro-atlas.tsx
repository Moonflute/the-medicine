...
function PlexusMap({ viewId, ...props }: Props) {
 const {layer,pathwayId,selectedId,hoveredId,onSelect,onHover}=props;const c={selectedId,hoveredId,onSelect,onHover};const upper=viewId==='brachial-plexus';
...
export const nativeNeuroViewIds = new Set(["whole-neuraxis", "cerebrum-lateral", "brain-midsagittal", "cerebrum-inferior", "brain-coronal", "brain-axial", "brainstem-external", "brainstem-section", "cerebellum", "spinal-levels", "spinal-cross-section", "brachial-plexus", "lumbosacral-plexus", "upper-limb-nerves", "lower-limb-nerves", "dermatome-anterior", "dermatome-posterior", "nmj-muscle"]);

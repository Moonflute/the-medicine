...
const organIds=new Set(["skeleton","brain","lungs","larynx","gallbladder","thyroid","adrenals","testes","pharynx","heart","liver","kidneys","pancreas","spleen","small-intestine","colon","bladder","ureters","prostate","spinal-cord","eyes","nose","ears","thymus","skin","uterus","ovaries","fallopian-tubes","lymph-node","knees","pelvis","urethra","vasculature","stomach","esophagus","mouth","tonsils"]);

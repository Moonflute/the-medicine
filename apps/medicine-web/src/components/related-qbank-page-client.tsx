...
import type { DiseaseHierarchy, QbankQuestionIndex } from "@/lib/types";

export function RelatedQbankPageClient({ questions, hierarchy }: { questions: QbankQuestionIndex[]; hierarchy: DiseaseHierarchy }) {

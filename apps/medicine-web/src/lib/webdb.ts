...
export type NeuroAtlas = {
  ...
  views: Array<{ id: string; label: string; description: string; group?: string; orientation?: string; baseAsset?: string; interactionMap?: string; sourceIds?: string[]; assetId?: string; assetMethod?: "public-domain-source" | "licensed-source" | "independently-redrawn"; assetSourceIds?: string[]; assetLicense?: string; assetSha256?: string; createdAs?: "project-original-svg"; referenceSourceIds?: string[]; anatomyReviewStatus?: "source-mapped"; visualReviewStatus?: "design-system-checked"; reviewScope?: string; reviewStatus?: "draft-anatomy" | "source-checked" | "review-ready"; status?: "source-checked" | "draft-anatomy" | "review-ready"; variants?: string[]; variantAssets?: Record<string,{ asset: string; assetId: string; sourceIds: string[]; license: string; sha256?: string; reviewStatus?: "draft-anatomy" | "source-checked" | "review-ready" }> }>;

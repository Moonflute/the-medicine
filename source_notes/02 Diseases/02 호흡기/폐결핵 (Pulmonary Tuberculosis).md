...
- 결핵이 의심되는 영상 소견은 가능한 과거 흉부 영상과 비교해 새 병변·진행 여부를 판단한다.
...
- AFB 도말 양성이면서 결핵 NAAT가 음성이면 NTM 가능성을 고려하고, 배양 뒤 동정으로 결핵균복합체와 구분한다. 조직을 얻는 경우에도 병리와 함께 항산균 배양 및 NAAT를 의뢰한다.

...
- 심초음파는 심낭눌림·급성 심근경색 등 대체 원인 감별과 우심실 평가에 도움이 되지만, 혈역학적으로 안정된 환자에서 정상 심초음파 소견만으로 PE를 배제할 수는 없다.
...
- 혈전성향검사는 모든 PE 환자에게 일괄 시행하지 않으며, 결과가 항응고 기간·가족상담 또는 다른 치료 결정을 바꿀 수 있는 선택된 상황에서 고려한다.

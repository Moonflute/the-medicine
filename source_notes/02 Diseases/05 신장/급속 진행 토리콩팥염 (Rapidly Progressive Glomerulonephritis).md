...
- **정의**
  ...
  - 광범위 반월체성 사구체신염은 통상 사구체의 50% 이상에서 반월체(crescent)가 형성된 조직 패턴을 뜻하지만, RPGN은 수 주에서 수 개월에 걸친 급속 신기능 악화라는 임상 증후군으로 두 용어를 동일어로 사용하지 않는다.
...
- **조직 검사**: 조기 신장 조직검사로 반월체 형성의 범위와 면역형광 소견을 확인한다. 면역형광의 선형(Anti-GBM), 과립형(면역복합체), 또는 소수면역성 패턴은 anti-GBM·ANCA 및 보체 결과와 연계해 원인 질환을 감별한다. 혈청 항체가 음성이어도 임상상과 조직 소견이 맞으면 해당 질환을 배제하지 않는다.

## 4. 진단 (Diagnosis)
- 급격한 신기능 저하와 혈뇨/적혈구 원주 확인
- 혈청학적 검사(항체 선별) 및 조기 신장 조직검사를 연계해 평가한다. 저보체혈증에서는 감염 관련 사구체신염(심내막염·내장 농양 등), 루푸스 신염 및 cryoglobulin 관련 질환을 병력·진찰·감염 평가와 함께 검토한다.
- 활동성 요침사와 급속 신기능 저하를 보이면 악성 고혈압, 혈전미세혈관병증(TMA), 약물성 간질신염, 경피증 신위기 및 죽상색전 같은 비사구체 모방 질환도 임상 맥락에 따라 감별한다.
...
출처 : Merck Manual Professional (RPGN); 삼성서울병원 메뉴얼
Last updated :

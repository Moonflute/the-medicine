...
anatomy.skeleton={source:'BodyParts3D 4.3',reference:'https://lifesciencedb.jp/bp3d/',landmarks:['골격과 보조 연골 242개 메시. 경추·흉추·요추 24개, 갈비뼈 24개, 추간판 23개를 포함합니다.','같은 원본 좌표를 유지합니다. 기존 HRA 장기 모음과 자동 정합하지 않습니다.','꼬리뼈의 독립 분할, 일부 작은 뼈와 관절면의 상세 검수는 진행 중입니다.']};

...
const standard={VH_M_heart_left_ventricle:'Left ventricle',VH_M_heart_right_ventricle:'Right ventricle',VH_M_left_cardiac_atrium:'Left atrium',VH_M_right_cardiac_atrium:'Right atrium',VH_M_left_anterior_descending_artery:'Anterior interventricular branch of left coronary artery (LAD)'};

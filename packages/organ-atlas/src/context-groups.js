export const contextGroups=[
 {id:'hepatopancreatic',members:['liver','pancreas'],controlId:'hepatopancreatic-context',label:'간·담도·췌장 함께 보기',description:'HRA 원본 좌표로 간·담낭·담도와 췌장·췌관을 조합했습니다. 총담관은 원본의 췌장 모델에 수록되어 함께 표시합니다. 모든 간내 담관 분지·십이지장 유두·조직층과 실제 담즙 흐름은 재현하지 않습니다.'},

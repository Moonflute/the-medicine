import {nerveRegions} from './src/body-nerve-catalog.js';
...
import {loadNeuralDetail} from './src/body-nerve-detail.js';import {disposeDetailModel} from './src/detail-resources.js';
...
for(const region of nerveRegions){
 const root=await loadNeuralDetail(region.id),frame=root.userData.detail.sourceFrame;
